...
a sole "[default]" section and the following elements in that section:
  ...
  omit_colophon:       If present, the colophon at the end of pages
                       "this page is generated by csv2wiki..." is omitted.
...
class WikiSession:
    ...
    def __init__(self, config, csv_input, null_as_value, msg_out, dry_run_out, make_non_editable):
        ...
        self._omit_colophon      = config.get('omit_colophon', False)
    ...
    def _save_page(self, page_title, text):
        ...
        #
        # We allow the configuration to omit through the omit_colophon option
        colophon = ""
        if not self._omit_colophon:
            colophon = "\n\n"                                           \
