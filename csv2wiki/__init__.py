...
class WikiSession:
    ...
    def _save_page(self, page_title, text, include_colophon=True):
        ...
        #
        # There are situations where we don't want to include it, though,
        # such as adding extra pages
        colophon = ""
        if include_colophon:
            colophon = "\n\n"                                           \
    ...
    def add_helper_pages(self, helper_pages):
        ...
        for helper_page in helper_pages:
            ...
            self._save_page(page_title, "\n".join(file_contents[1:]), include_colophon=False)
            self._maybe_msg(("CREATED PAGE: \"" + page_title + "\"\n"))
